...
namespace tml::Interface
{
    ...
    enum class AlignPolicy { Near, Center, Far };

    class Interface;

    class TML_API Component : NonCopyable
    {
    public:
        struct State
        {
    ...
    public:
        ...
        int64_t GetIndex(const Component* child) const noexcept;
        Component* GetChildByIndex(int64_t index) noexcept;
        ...
        virtual std::string_view GetType() const noexcept = 0; //!< Returns the type of the component as a string.
    ...
    protected:
		...
		std::pair<uint64_t,std::string> m_id; //!< hash and string
